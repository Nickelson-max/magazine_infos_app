    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.asset('assets/images/magazineInfo.jpg', width: double.infinity, height: 250, fit: BoxFit.cover),
            const Padding(
              padding: EdgeInsets.all(20.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Bienvenue au Magazine Infos', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.black87)),
                  SizedBox(height: 5),
                  Text('Votre magazine numérique, votre source d\'inspiration', style: TextStyle(fontSize: 14, fontStyle: FontStyle.italic, color: Colors.grey)),
                ],
              ),
            ),
            const Padding(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Tu as cliqué dessus')));
        },
        backgroundColor: Colors.pink,
  ...
  Widget _buildIconAction(IconData icon, String label) {
    return Column(
      children: [
        ...
        Text(label, style: const TextStyle(color: Colors.pink, fontSize: 12, fontWeight: FontWeight.bold)),
      ],
    );
  }
}